...
#[derive(Debug)]
pub struct CryptoForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoForge processing");
    
    let mut processor = CryptoForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoForgeProcessor::new(false);
